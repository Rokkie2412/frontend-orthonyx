...
import { DateInput, InputField, LoadingModal, Modal } from "../../../components";
import { addNewUser } from '../../../utils/apiCall';
import { addDataUserValidationSchema } from '../../../utils/general';

import type { AddPatientProps, FormikPropsData } from './addPatient.types'
